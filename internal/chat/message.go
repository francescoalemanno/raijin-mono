...
func defaultMarkdownTheme() components.MarkdownTheme {
	return components.MarkdownTheme{
		Heading:         theme.ColorForegroundBold,
		Link:            theme.ColorAccent,
		LinkURL:         theme.ColorMuted,
		Code:            theme.ColorAccentAlt,
		CodeBlock:       theme.ColorForeground,
		CodeBlockBorder: theme.ColorMuted,
		Quote:           theme.ColorMuted,
		QuoteBorder:     theme.ColorMuted,
		HR:              theme.ColorMuted,
		ListBullet:      theme.ColorAccent,
		Bold:            theme.ColorForegroundBold,
		Italic:          theme.ColorForeground,
		Strikethrough:   theme.ColorMuted,
		Underline:       theme.ColorForegroundUnderline,
